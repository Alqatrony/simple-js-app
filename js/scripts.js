let pokemonRepository = (function() {
  ...
  function addListItem(pokemon) {
    ...
    button.innerHTML = "<img src='Images/pokeball.png' class='pokeball'> " + pokemon.name + " <img src='Images/pokeball.png' class='pokeball'>" ;
...
function loadList() {
  ...
  searchInput.addEventListener('input', function(){
    ...
    listPokemon.forEach(function(pokemon){
       if(pokemon.innerHTML.toLowerCase().indexOf(value) > -1){
